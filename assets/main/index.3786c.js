    ...
    MainGameJS: [function (e, t) {
        ...
        e("../MainManage").endHttpShowInfo, cc.Class({
            ...
            JudgeSmallFish: function () {
                ...
                if (this.playerNode.getChildByName("son").children.length > 0 ) {
                    cc.audioEngine.play(this.HurtMusic, !1, 1);
                    this.chooseBiggerFish()
                } else {
                    this.DieAction();
                }
            },
            ...
            onCollisionEnter: function (e, t) {
                if (!this.mainSelf.gameOverFlags) {
                    if (this.mainSelf.collision = t.node, (t.tag = 666) && 1 == e.tag) {
                        var a = e.node.typeID;
                        // if (this.mainSelf.playerNode.typeID >= a) {
                            e.tag = 999;
